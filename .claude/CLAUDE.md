...
3. **Block** if `make test-coverage` fails (enforces the 75% floor from `.settings.yaml`, excluding `validators/` — see #1752; do not use per-package profiles for this check).
