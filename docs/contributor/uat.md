...
| `daytime-up` | `aicr-uat-day-<reservation>-<run_id>` — **ephemeral** | yes | yes (prep→install) | no | **holds on success; tears down on failure/cancellation** |
