...
- **Phases**:
  - **Pre-deployment**: Validates infrastructure prerequisites (K8s version, OS, kernel) and runs pre-deployment checks
...
- **CLI**: `eidos validate --phase <phase>` (default: pre-deployment)
