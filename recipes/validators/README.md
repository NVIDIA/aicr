...
| `nccl-cre-all-reduce-bw` | EKS H100 NCCL via CRE `Certification` (`communication/nccl-all-reduce`) (opt-in) | 30m |
| `cre-training-goodput` | EKS H100 NeMo goodput via CRE `WorkloadRun` (opt-in) | 30m |
